...
class Nature(
  ...
  val linearMotionIntegral:LinearMotionIntegral = LinearMotionIntegral(BruteForceLinearMotionCollisionDetector(QuadraticLinearMotionCollisionDetectionStrategy())),
