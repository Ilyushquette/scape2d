...
class CircleSweepsIntersectionTest {
  ...
  def testSeparatedCircleSweepsDontIntersect = {
    val cs1 = CircleSweep(Circle(Point(0, 0), 2), Vector.from(Components(22, 0)));
    val cs2 = CircleSweep(Circle(Point(4.5, 14), 2), Vector.from(Components(3.5, -8)));
  ...
  def testCircleSweepReachesDestinationCircleOfCircleSweepDoIntersect = {
    val cs1 = CircleSweep(Circle(Point(0, 0), 2), Vector.from(Components(22, 0)));
    val cs2 = CircleSweep(Circle(Point(28.5, 14), 2), Vector.from(Components(-6.5, -14)));
  ...
  def testCircleSweepReachesRectangularConnectorOfCircleSweepDoIntersect = {
    val cs1 = CircleSweep(Circle(Point(0, 0), 2), Vector.from(Components(22, 0)));
    val cs2 = CircleSweep(Circle(Point(4.5, 14), 2), Vector.from(Components(5, -11)));
    Assert.assertTrue(cs1.intersects(cs2));
  }
  ...
  def testCircleSweepInsideOfAnotherCircleSweepDoIntersect = {
    val cs1 = CircleSweep(Circle(Point(0, 0), 2), Vector.from(Components(22, 0)));
    val cs2 = CircleSweep(Circle(Point(10, 0), 1), Vector.from(Components(4, 0)));
    Assert.assertTrue(cs1.intersects(cs2));
  }
}