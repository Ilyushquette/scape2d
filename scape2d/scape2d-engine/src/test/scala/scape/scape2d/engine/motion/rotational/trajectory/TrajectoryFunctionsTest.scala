...
class TrajectoryFunctionsTest {
  ...
  def testTrajectoryOfNonRotatable:Unit = {
    val movable = new MovableMock(Circle(Point.origin, 0.1), Vector.zero, None);
    trajectoryOf(movable)
  }
  
  @Test
  def testTrajectoryOfRotatable = {
    val movable = new MovableMock(Circle(Point(1, 6), 0.5), Vector.zero, None);
  ...
  def testCrossPathsNonRotatablesNoIntersection = {
    val movable1 = new MovableMock(Circle(Point(0, 1), 0.1), Vector.zero, None);
    val movable2 = new MovableMock(Circle(Point.origin, 0.1), Vector.zero, None);
  ...
  def testCrossPathsRotatableWithNonRotatableIntersection = {
    val movable1 = new MovableMock(Circle(Point(0, 1), 0.1), Vector.zero, None);
    val movable2 = new MovableMock(Circle(Point(0, -1), 0.1), Vector.zero, None);
  ...
  def testCrossPathsRotatableWithNonRotatableNoIntersection = {
    val movable1 = new MovableMock(Circle(Point(0, 1), 0.1), Vector.zero, None);
    val movable2 = new MovableMock(Circle(Point(0, -1.5), 0.1), Vector.zero, None);
    val rotatable1 = new RotatableMock(Point.origin, 0.5, Set(movable1));
    Assert.assertFalse(crossPaths(movable1, movable2));
  }
  ...
  def testCrossPathsStationariesNoIntersection = {
    val movable1 = new MovableMock(Circle(Point(1, 0), 0.1), Vector.zero, None);
    val movable2 = new MovableMock(Circle(Point(-2, 0), 0.1), Vector.zero, None);
  ...
  def testCrossPathsRotatableWithStationaryIntersection = {
    val movable1 = new MovableMock(Circle(Point.origin, 0.1), Vector.zero, None);
  ...
  def testCrossPathsRotatableWithStationaryNoIntersection = {
    val movable1 = new MovableMock(Circle(Point(3, 0), 0.1), Vector.zero, None);
    val movable2 = new MovableMock(Circle(Point(-2, 0), 0.1), Vector.zero, None);
  ...
  def testCrossPathsRotatablesIntersection = {
    val movable1 = new MovableMock(Circle(Point(-3, 0), 0.5), Vector.zero, None);
    val rotatable1 = new RotatableMock(Point.origin, 0.3, Set(movable1));
    val movable2 = new MovableMock(Circle(Point(7, -3), 0.5), Vector.zero, None);
  ...
  def testCrossPathsRotatablesNoIntersectionSmallRadiiDecreased = {
    val movable1 = new MovableMock(Circle(Point(-3, 0), 0.4), Vector.zero, None);
    val movable2 = new MovableMock(Circle(Point(7, -3), 0.4), Vector.zero, None);
    val rotatable1 = new RotatableMock(Point.origin, 0.3, Set(movable1));
    val rotatable2 = new RotatableMock(Point(7, 0), -0.3, Set(movable2));
    Assert.assertFalse(crossPaths(movable1, movable2));
  }
  ...
  def testCrossPathsRotatablesNoIntersectionLargeRadiusDecreased = {
    val movable1 = new MovableMock(Circle(Point(-2.9, 0), 0.5), Vector.zero, None);
    val movable2 = new MovableMock(Circle(Point(7, -3), 0.5), Vector.zero, None);
    val rotatable1 = new RotatableMock(Point.origin, 0.3, Set(movable1));
    val rotatable2 = new RotatableMock(Point(7, 0), -0.3, Set(movable2));
    Assert.assertFalse(crossPaths(movable1, movable2));
